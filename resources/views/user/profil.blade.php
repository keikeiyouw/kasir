...
<nav>
    ...
    <div class="nav-right">
        ...
        <a href="{{ route('user.profil') }}" class="active">Profil</a>
            ...
            <form action="{{ route('user.profil.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="NomorTelepon" class="form-control"
                        value="{{ $pelanggan && $pelanggan->NomorTelepon != '-' ? $pelanggan->NomorTelepon : '' }}"
                        placeholder="08xxxxxxxxxx">
                </div>
                <div class="form-group">
                    <label class="form-label">Alamat</label>
                    <textarea name="Alamat" class="form-control" rows="3" placeholder="Alamat lengkap...">{{ $pelanggan && $pelanggan->Alamat != '-' ? $pelanggan->Alamat : '' }}</textarea>
                </div>
