...
<head>
    ...
    <title>@yield('title') — Releaf</title>
...
<aside class="sidebar">
    ...
    <nav class="nav">
        ...
        <a href="{{ route('detailpenjualan.index') }}" class="{{ request()->routeIs('detailpenjualan.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-foot">
        <div class="foot-user">
            <div class="foot-avatar">{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}</div>
            <div>
                <div class="foot-name">{{ Auth::user()->name }}</div>
...
<div class="main">
    <div class="topbar">
        <div class="topbar-inner">
            ...
            <div class="topbar-date">{{ now()->isoFormat('HH.mm.ss') }}</div>
        </div>
    </div>
    <div class="content">
        @if(session('success'))
