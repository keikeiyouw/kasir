...
<div class="right">
    <div class="form-wrap">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group"><label class="form-label">Email</label><input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="contoh@gmail.com" required autofocus></div>
        ...
        <div class="footer-link">Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar</a></div>
    </div>
</div>
<script>
function setRole(r){
...
</html><?php /**PATH C:\laragon\www\kasir\resources\views/auth/login.blade.php ENDPATH**/ ?>