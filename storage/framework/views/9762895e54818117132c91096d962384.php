...
<div class="right">
    <div class="form-wrap">
        ...
        <form method="POST" action="<?php echo e(route('password.email')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group"><label class="form-label">Email</label><input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="email@contoh.com" required autofocus></div>
            <button type="submit" class="btn-submit">Kirim Link Reset</button>
        </form>
        <div class="footer-link"><a href="<?php echo e(route('login')); ?>">← Kembali login</a></div>
    </div>
</div>
</body>
</html><?php /**PATH C:\laragon\www\kasir\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>