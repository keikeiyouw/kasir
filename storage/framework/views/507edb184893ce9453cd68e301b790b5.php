    ...
    <div class="form-wrap">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control <?php echo e($errors->has('name') ? 'err' : ''); ?>" value="<?php echo e(old('name')); ?>" placeholder="Nama lengkap" required autofocus>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control <?php echo e($errors->has('email') ? 'err' : ''); ?>" value="<?php echo e(old('email')); ?>" placeholder="email@contoh.com" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="pw" class="form-control <?php echo e($errors->has('password') ? 'err' : ''); ?>" placeholder="Minimal 8 karakter" required oninput="cekKuat(this.value)">
                <div class="strength">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="footer-link">Sudah punya akun? <a href="<?php echo e(route('login')); ?>">Masuk</a></div>
    </div>
</div>
<script>
function cekKuat(v){
...
</html><?php /**PATH C:\laragon\www\kasir\resources\views/auth/register.blade.php ENDPATH**/ ?>