...
<nav>
    ...
    <div class="nav-right">
        ...
        <a href="<?php echo e(route('user.keranjang')); ?>" class="active">Keranjang <?php if($items->count() > 0): ?>(<?php echo e($items->count()); ?>)<?php endif; ?></a>
...
<div class="page-header">
    ...
    <p><?php echo e($items->count()); ?> produk di keranjang</p>
</div>
...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="item">
            ...
            <div class="item-info">
                <div class="item-name"><?php echo e($item->produk->NamaProduk); ?></div>
                <div class="item-price">Rp <?php echo e(number_format($item->produk->Harga, 0, ',', '.')); ?></div>
            </div>
            <div class="item-qty">
                <form action="<?php echo e(route('user.keranjang.update', $item)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="jumlah" value="<?php echo e(max(1, $item->jumlah - 1)); ?>">
                    <button type="submit" class="qty-btn">−</button>
                </form>
                <span class="qty-num"><?php echo e($item->jumlah); ?></span>
                <form action="<?php echo e(route('user.keranjang.update', $item)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="jumlah" value="<?php echo e($item->jumlah + 1); ?>">
                    <button type="submit" class="qty-btn">+</button>
                </form>
            </div>
            <div class="item-subtotal">Rp <?php echo e(number_format($item->produk->Harga * $item->jumlah, 0, ',', '.')); ?></div>
            <form action="<?php echo e(route('user.keranjang.hapus', $item)); ?>" method="POST" id="hapus-<?php echo e($item->id); ?>">
                <?php echo csrf_field(); ?>
                <button type="button" class="btn-hapus" onclick="showHapus(<?php echo e($item->id); ?>)">✕</button>
            </form>
        </div>
    ...
    <div class="checkout-box">
        <div class="total-row">
            ...
            <span class="total-val">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></span>
        </div>
        <form action="<?php echo e(route('user.keranjang.checkout')); ?>" method="POST" id="form-checkout">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\kasir\resources\views/user/keranjang.blade.php ENDPATH**/ ?>